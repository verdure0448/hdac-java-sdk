...
public class HdacCommand {
	...
	public HdacCommand(String ip, String port, String login, String password, RuntimeParameters runtimeparameters) {
		super();
	...
	public HdacCommand(String ip, String port, String login, String password) {
	...
	public MiningCommand getMiningCommand() {
		return miningCommand;
	}
	
	public void setMiningCommand(MiningCommand miningCommand) {
		this.miningCommand = miningCommand;
	}
}
