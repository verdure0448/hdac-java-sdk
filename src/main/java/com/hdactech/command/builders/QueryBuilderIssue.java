...
import com.hdactech.object.formatters.CustomParamFormatter;
...
public class QueryBuilderIssue extends QueryBuilderCommon {
	 ...
	 * 
	 */
	protected Object executeGetAssetBalances() throws HdacException {
	...
	protected Object executeIssue(	String address,
		...
		HdacTestParameter.valueIsPositive("quantity", quantity);
		HdacTestParameter.valueIsPositive("unit", unit);
		HdacTestParameter.valueIsNotNegative("float", amount);
	 ...
	 * @throws HdacException
	 */
	protected Object executeIssueMore(String address, String assetName, int quantity) throws HdacException {
		HdacTestParameter.isNotNullOrEmpty("address", address);
		HdacTestParameter.isNotNullOrEmpty("assetName", assetName);
		HdacTestParameter.valueIsPositive("quantity", quantity);
	 ...
	 * @throws HdacException
	 */
	protected Object executeListAssets(String asset, boolean verbose) throws HdacException {
	 ...
	 */
	protected Object excuteListUnspent(int minconf, int maxconf, String[] addresses) throws HdacException {
		HdacTestParameter.valueIsPositive("minconf", minconf);
		HdacTestParameter.valueIsPositive("maxconf", maxconf);
		
		return execute(CommandEnum.LISTUNSPENT, minconf, maxconf, addresses);
	}
