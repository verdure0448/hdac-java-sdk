...
import com.hdactech.object.formatters.HexFormatter;
...
public class QueryBuilderWalletTransaction extends QueryBuilderCommon {
	 ...
	 */
	protected Object executeGetAddressTransaction(String address, String txid, boolean verbose) throws HdacException {
	 ...
	 */
	protected Object excuteGetAssetTransaction(String assetName, String txid, boolean verbose) throws HdacException {
		HdacTestParameter.isNotNullOrEmpty("assetName", assetName);
		HdacTestParameter.isNotNullOrEmpty("txid", txid);
		return execute(CommandEnum.GETASSETTRANSACTION, assetName, txid, verbose);
	}
	 ...
	 * @throws HdacException
	 */
	protected Object executeGetTransaction(String txid, boolean includeWatchonly) throws HdacException {
		HdacTestParameter.isNotNullOrEmpty("txid", txid);
	 ...
	 * @throws HdacException
	 */
	protected Object executeGetTxOut(String txid, int vout, boolean includemempool) throws HdacException {
		HdacTestParameter.isNotNullOrEmpty("txid", txid);
	 ...
	 * @throws HdacException
	 */
	protected Object executeGetWalletTransaction(String txid, boolean includeWatchOnly, boolean verbose) throws HdacException {
	 ...
	 * @throws HdacException
	 */
	protected Object executeListAddressTransactions(String address, long count, long skip, boolean verbose) throws HdacException {
		HdacTestParameter.isNotNullOrEmpty("address", address);
		HdacTestParameter.valueIsPositive("count", count);
		HdacTestParameter.valueIsNotNegative("skip", skip);
	 ...
	 * @throws HdacException
	 */
	protected Object executeListWalletTransaction(long count, long skip, boolean includeWatchonly, boolean verbose) throws HdacException {
		HdacTestParameter.valueIsPositive("count", count);
		HdacTestParameter.valueIsNotNegative("skip", skip);
	 ...
	 * Method created for ver 0.92.
	 */
	protected Object executeSend(String address, List<AssetQuantity> assets) throws HdacException {
		HdacTestParameter.isNotNullOrEmpty("address", address);
		...
		for (AssetQuantity asset : assets) {
			asset.isFilled();
			mapAssets.put(asset.getName(), new Double(asset.getQuantity()));
		}

		return execute(CommandEnum.SEND, address, mapAssets);
	}
	/**
	 * 
	 ...
	 */
	protected Object executeSendFromAddress(String fromAddress, String toAddress, List<AssetQuantity> assets) throws HdacException {
		HdacTestParameter.isNotNullOrEmpty("fromAddress", fromAddress);
		HdacTestParameter.isNotNullOrEmpty("toAddress", toAddress);
		if (assets == null || assets.isEmpty()) {
			throw new HdacException("assets", "assets needed to be sent");
		}
	 ...
	 * @throws HdacException
	 */
	protected Object executeSendFromAddress(String fromAddress, String toAddress, double amount) throws HdacException {
		HdacTestParameter.isNotNullOrEmpty("fromAddress", fromAddress);
		HdacTestParameter.isNotNullOrEmpty("toAddress", toAddress);
		HdacTestParameter.valueIsNotNegative("amount", amount);
	 ...
	 * @throws HdacException
	 */
	protected Object executeSendToAddress(String address, List<BalanceAssetGeneral> assets) throws HdacException {
		HdacTestParameter.isNotNullOrEmpty("address", address);
		if (assets == null || assets.isEmpty()) {
			throw new HdacException("assets", "assets needed to be sent");
		}
	 ...
	 * @throws HdacException
	 */
	protected Object executeSendToAddress(String address, double amount) throws HdacException {
		HdacTestParameter.isNotNullOrEmpty("address", address);
		HdacTestParameter.valueIsNotNegative("amount", amount);
	 ...
	 * Parameter changed for ver 0.92.
	 */
	protected Object executeSendWithMetaData(String address, List<AssetQuantity> assets, String hexMetaData) throws HdacException {
		HdacTestParameter.isNotNullOrEmpty("address", address);
		HdacTestParameter.isNotNullOrEmpty("hexMetaData", hexMetaData);
		if (assets == null || assets.isEmpty()) {
			throw new HdacException("assets", "assets needed to be sent");
		}
		Map<String, Double> mapAssets = new HashMap<String, Double>();
	 ...
	 * @throws HdacException
	 */
	protected Object executeSendWithMetaData(String address, double amount, String hexMetaData) throws HdacException {
		HdacTestParameter.isNotNullOrEmpty("address", address);
		HdacTestParameter.isNotNullOrEmpty("hexMetaData", hexMetaData);
		HdacTestParameter.valueIsNotNegative("amount", amount);
	 ...
	 * @throws HdacException
	 */
	protected Object executeSendWithMetaDataFrom(String fromAddress, String toAddress, List<BalanceAssetGeneral> assets, String hexMetaData) throws HdacException {
		HdacTestParameter.isNotNullOrEmpty("fromAddress", fromAddress);
		HdacTestParameter.isNotNullOrEmpty("toAddress", toAddress);
		HdacTestParameter.isNotNullOrEmpty("hexMetaData", hexMetaData);
	 ...
	 * @throws HdacException
	 */
	protected Object executeSendWithMetaDataFrom(String fromAddress, String toAddress, double amount, String hexMetaData) throws HdacException {
		HdacTestParameter.isNotNullOrEmpty("fromAddress", fromAddress);
		HdacTestParameter.isNotNullOrEmpty("toAddress", toAddress);
		HdacTestParameter.isNotNullOrEmpty("hexMetaData", hexMetaData);
		HdacTestParameter.valueIsNotNegative("amount", amount);
	...
	protected Object executeSendWithDataFrom(String fromAddress, String toAddress, String assetName, Integer assetValue, String metadata) throws HdacException {
		HdacTestParameter.isNotNullOrEmpty("fromAddress", fromAddress);
		HdacTestParameter.isNotNullOrEmpty("toAddress", toAddress);
		HdacTestParameter.isNotNullOrEmpty("metadata", metadata);
		HdacTestParameter.isNotNull("asset", assetName);
		HdacTestParameter.valueIsNotNegative("assetValue", assetValue);
